      ...
      <div className="container mx-auto px-6 py-16 max-w-4xl animate-fade-in">
        ...
        <div className="space-y-6 text-muted-foreground">
          <section>
            ...
            <p>
              A MonitorPro está totalmente comprometida com a Lei Geral de Proteção de Dados (LGPD - Lei nº 13.709/2018) 
              e garante que todos os dados pessoais são tratados com segurança e transparência.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              comunicações dos titulares de dados através do e-mail: dpo@monitorpro.com
            </p>
          </section>
